...
namespace OnlineShoppingStore.Controllers
{
    public class AdminCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryId,CategoryName,IsActive,IsDelete,CategoryImg")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryId,CategoryName,IsActive,IsDelete,CategoryImg")] Category category)
        {
            if (ModelState.IsValid)
            {
